    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto p-4 p-lg-0">
                ...
                <a href="pags/pag_produtos.php" class="nav-item nav-link">Produtos</a>
                <a href="pags/categorias.php" class="nav-item nav-link">Categorias</a>
                <a href="pags/curiosidades.php" class="nav-item nav-link">Curiosidades</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Outros</a>
                    <div class="dropdown-menu m-0">
                        <a href="pags/contato.php" class="dropdown-item">Fale Conosco</a>
                        <a href="pags/conta.php" class="dropdown-item">Conta</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="row g-2 mb-4">
                            ...
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-2"></i>Produtos Customizados
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-2"></i>Compra On-line
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-2"></i>Entrega em Casa
                            </div>
                        </div>
                    </div>
                </div>
